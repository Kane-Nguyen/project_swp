      ...
      <form
        ...
        <div class="form-group">
          ...
          <input
            ...
            accept=".jpg, .jpeg, .png"
            required />
          <div id="mainImagePreview" class="img-preview-container"></div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            multiple
            accept=".jpg, .jpeg, .png" />
          <div id="additionalImagesPreview" class="img-preview-container"></div>
          <!-- Image preview container -->
          <span id="imageLimitMessage" class="text-danger"></span>
          <!-- Image limit message placeholder -->
        </div>
