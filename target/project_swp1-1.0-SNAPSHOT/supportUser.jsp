...
<%-- 
    ...
    Created on : Mar 8, 2024, 11:32:59 AM
    Author     : TU ANH
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <a href="/" class="btn btn-primary text-white" style="padding: 4px; height: 40px; white-space: nowrap">Về trang chủ</a>
            <div class="box" style="width: 160px;">
                ...
                <h5 style="font-size: 20px;">Địa chỉ công ty của chúng tôi</h5>
                <p>277, kdt244,Phường An Khánh, Quận Ninh Kiều, Thành Phố Cần Thơ</p>
            </div>
            <div class="box" style="width: 160px;">
                ...
                <h5 style="font-size: 20px;">Liên Hệ</h5>
                <p>0333942694</p>
            </div>
            <div class="box" style="width: 160px;">
            ...
            <div class="box" style="width: 160px;">
                <span style="margin-top: -50%; width: 90px;" class="u-icon u-icon-circle u-text-palette-1-base u-icon-4"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style=""></svg><svg class="u-svg-content" viewBox="0 0 512 512" x="0px" y="0px" id="svg-9f82" style="enable-background:new 0 0 512 512;"><g><g><path d="M507.49,101.721L352.211,256L507.49,410.279c2.807-5.867,4.51-12.353,4.51-19.279V121    C512,114.073,510.297,107.588,507.49,101.721z"></path>
                    </g>
                ...
                <p>Khanhce171115@fpt.edu.vn & daihocfpt@fpt.edu.vn</p>
            </div>
        </div>

        <div class="container" style="padding-top:0px;">
            <div class="left">
                <div style=" color:#000;display: flex;justify-content: center;flex-direction: column;align-items: center;">
                    <h3 style="font-size: 40px; margin-top: 0px;">Giới Thiệu Về Công Ty</h3>
                    <p style="font-size: 21px; text-spacing: 10px;">"E-commerce Selling Products" là một công ty tiên phong trong lĩnh vực thương mại điện tử, chuyên về việc cung cấp các sản phẩm đa dạng và chất lượng cao cho khách hàng trên toàn thế giới. Với nền tảng công nghệ tiên tiến và đội ngũ nhân viên giàu kinh nghiệm, chúng tôi cam kết mang đến trải nghiệm mua sắm trực tuyến tuyệt vời nhất cho người tiêu dùng. Chúng tôi không chỉ cung cấp các sản phẩm phong phú từ nhiều lĩnh vực khác nhau như thời trang, điện tử, đồ gia dụng, mà còn tạo ra một môi trường mua sắm thuận tiện và an toàn. Sứ mệnh của chúng tôi là đem lại sự hài lòng tối đa cho khách hàng thông qua sự đổi mới liên tục và dịch vụ chuyên nghiệp, từ việc tìm kiếm sản phẩm đến quy trình thanh toán và giao hàng. Chúng tôi tin rằng việc phục vụ khách hàng tận tâm và chất lượng là chìa khóa để xây dựng một cộng đồng mua sắm trực tuyến bền vững và phát triển.</p>
                    <img style="width: 250px;border-radius: 46%;" src="./img-module/logo.png" alt="alt">
